  ...
  async createTurf(authId: string, dto: CreateTurfDto) {
    ...
    const recentDuplicate = await this.prisma.turf.findFirst({
      where: {
        ...
        footballs: dto.footballs ?? false,
        cricketNets: dto.cricketNets ?? false,
        bibs: dto.bibs ?? false,
        goalPosts: dto.goalPosts ?? false,
        wifi: dto.wifi ?? false,
        cctv: dto.cctv ?? false,
        firstAid: dto.firstAid ?? false,
  ...
  async updateTurf(authId: string, turfId: string, dto: UpdateTurfDto) {
    ...
    const updated = await this.prisma.turf.update({
      ...
      data: {
        ...
        ...(dto.footballs !== undefined && { footballs: dto.footballs }),
        ...(dto.cricketNets !== undefined && { cricketNets: dto.cricketNets }),
        ...(dto.bibs !== undefined && { bibs: dto.bibs }),
        ...(dto.goalPosts !== undefined && { goalPosts: dto.goalPosts }),
        ...(dto.wifi !== undefined && { wifi: dto.wifi }),
        ...(dto.cctv !== undefined && { cctv: dto.cctv }),
        ...(dto.firstAid !== undefined && { firstAid: dto.firstAid }),
